import json,xlwt,jsonpath,urllib3,time
def readExcel(file):
...
def writeM():
    ...
    if (method == 'url'):
        ...
        req_1 = {"uid":"98524936524","condition":"create_time","page":0,"size":35,"sort":[],"filterDelete":"true"}
        ...
        for video_id_1 in id_list: #　循环字典
            print(video_id_1)
        ...
        for video_id in id_list: #　循环字典
            ...
            if cid_list:
                ...
                continue
            book.save('url-output-'+video_id+'-excel.xls')
